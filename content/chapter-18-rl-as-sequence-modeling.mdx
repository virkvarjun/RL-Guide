...
**18.6 (implement)** Run the Section 7 code. Plot achieved-vs-prompted return across prompts {50, 100, ..., 700}; identify the tracking region and the ceiling. Then bias the dataset: drop all episodes with return above 300 and retrain — where does the ceiling move? (You are measuring the "no competence conjured" claim directly.)
